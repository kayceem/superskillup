# Generated by Django 5.0.3 on 2024-04-04 06:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(blank=True, max_length=255, null=True, upload_to=app.utils.utils.sub_topic_file_path)),
                ('file', models.FileField(blank=True, max_length=255, null=True, upload_to=app.utils.utils.sub_topic_file_path)),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('url', models.URLField(blank=True, null=True)),
                ('file', models.FileField(blank=True, max_length=255, null=True, upload_to=app.utils.utils.assignment_file_path)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='app.course')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('url', models.URLField(blank=True, null=True)),
                ('file', models.FileField(blank=True, max_length=255, null=True, upload_to=app.utils.utils.assignment_submission_file_path)),
