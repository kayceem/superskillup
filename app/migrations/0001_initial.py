    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_topic_questions', to='app.subtopic')),
                ('topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='topic_questions', to='app.topic')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            ...
            name='user_answer',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.useranswer'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='user_course_assignment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.usercourseassignment'),
        ),
