...
from app.models import UserProfile, UserAnswer, UserAssignment, Question, Course, Topic, SubTopic, GptReview, ManageFeedback
...
class UserAnswerAdmin(admin.ModelAdmin):
    list_display = ('id', "user", "question", "answer", "is_reviewed_by_gpt", "is_reviewed_by_manager")

@admin.register(UserAssignment)
class UserAssignmentAdmin(admin.ModelAdmin):
    list_display = ('id', "user", "question", "topic", "sub_topic", "course", "deadline", "status")
